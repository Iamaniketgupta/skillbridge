	...
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		...
		<div className="space-y-4">
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600">How does Skill Bridge match mentors with mentees?</summary>
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-600">Skill Bridge uses advanced algorithms and user-provided preferences to match mentees with mentors who have the relevant expertise and experience in their desired field. Our goal is to ensure a tailored and effective mentorship experience for all users.</p>
			</details>
			<details className="w-full border rounded-lg">
